-- LibAHTab-1.0
-- https://github.com/Auctionator/LibAHTab
-- MIT License, Copyright (c) 2022 plusmouse
-- Embedded verbatim: safely adds custom tabs to the Blizzard Auction House
-- frame without causing taint issues.
